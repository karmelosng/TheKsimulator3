...
//   
      s= f.load("KSim3DResources\\obj_1.obj");
      sm=f.load("KSim3DResources\\obj_2.obj");
     s2 = f.load("KSim3DResources\\obj_11.obj");
  }
    ...
    // objTrans.addChild(sm.getSceneGroup());
    
    objTrans.addChild(s.getSceneGroup());
    objTrans.addChild(sm.getSceneGroup());
    objTrans.addChild(s2.getSceneGroup());
  BoundingSphere bounds = new BoundingSphere(new Point3d(0.0,0.0,0.0), 100.0);
    ...
    objTrans.addChild(rotator);
        ...
        Color3f bgColor = new Color3f(0.05f, 0.05f, 0.5f);//0.05f, 0.05f, 0.5f
