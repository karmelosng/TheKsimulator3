 ...
 * @author jumoke
 */
public class AdminAddModuleTypePane extends javax.swing.JPanel {
    private SimAdminController controller;
    private DefaultListModel listSimModuleTypes;
    /**
     * Creates new form AdminAddModuleTypePane
     */
    public AdminAddModuleTypePane(String style, SimAdminController sac) {
        controller = sac;
        listSimModuleTypes= new DefaultListModel();
        initComponents();
        if(style.equalsIgnoreCase("add")){
   ...
   private void loadModuleTypeListModel(SimModuleType[] arrayType) {
    ...
    private void initComponents() {
        ...
        jList1.setModel(listSimModuleTypes);
        jList1.setToolTipText("");
        jScrollPane2.setViewportView(jList1);

        jLabel3.setText("Existing ModuleTypes:");
